...
# NuScenesBEVDataset / SimpleBEV import-gal main()-ku ulla iruku.
# Yaen? Avai cv2, nuscenes-devkit, timm ellathaiyum izhukkum. Aana
# decode_predictions() / ego_to_global() ku avai edhuvum thevai illa -
# antha rendaiyum vera edathula (Triton client, HF Space demo) import
# panna, antha heavy dependency ellam vendaam.
...
def main() -> None:
    # Intha rendu import inga (module-level illa) - avai cv2,
    # nuscenes-devkit, timm ellathaiyum izhukkum. decode_predictions()
    # / ego_to_global() ku avai thevai illa, so vera edathula (Triton
    # client, HF Space demo) light-a import panna mudiyum.
